...
struct Node *insertDescending(struct Node *head, int coefficient, int expo)
{
    struct Node *newNode = createNode(coefficient, expo);
...
struct Node *add(struct Node *p1Head, struct Node *p2Head)
{
    ...
    while (t1 != NULL && t2 != NULL)
    {
        ...
        {
            coeRes = (t1->coefficient + t2->coefficient);
            struct Node *newNode = createNode(coeRes, t1->exponent);
        ...
        {
            struct Node *newNode = createNode(t1->coefficient, t1->exponent);
            resultHead = insertAtEnd(resultHead, newNode);
            t1 = t1->next;
        }
        else if (t1->exponent < t2->exponent)
        {
            struct Node *newNode = createNode(t2->coefficient, t2->exponent);
            resultHead = insertAtEnd(resultHead, newNode);
            t2 = t2->next;
        }
    }
